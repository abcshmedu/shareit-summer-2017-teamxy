...
public enum MediaServiceResult {
    ...
    ALREADY_EXISTS(400, "The entity you wanted to createBook already exists.", Response.Status.BAD_REQUEST),
    ...
    UNAUTHORIZED(401, "The specified token is invalid or the auth server is unreachable.", Response.Status.UNAUTHORIZED),
